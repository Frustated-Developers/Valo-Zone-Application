...
class GhostDialog extends StatelessWidget {
  const GhostDialog({super.key});
          ...
          child: Column(
              ...
              children: [
                ClipRRect(
                    ...
                    child: Image.asset(AssetPath.ghost_gun)),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "The Ghost is a silenced sidearm. Perfect for stealth and precision shots.",
                        style: TextStyle(color: AppColors.greyText),
                      ),
                      SizedBox(
                        height: 20.h,
