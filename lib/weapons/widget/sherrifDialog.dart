...
class SherrifDialog extends StatelessWidget {
  const SherrifDialog({super.key});
          ...
          child: Column(
              ...
              children: [
                ClipRRect(
                    ...
                    child: Image.asset(AssetPath.sheriff_gun)),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "The Sheriff is a heavy revolver. Known for its high damage and precision accuracy.",
