...
class JudgeDialog extends StatelessWidget {
  const JudgeDialog({super.key});
          ...
          child: Column(
              ...
              children: [
                ClipRRect(
                    ...
                    child: Image.asset(AssetPath.judge_gun)),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "The Judge is an automatic shotgun. Devastating at close ranges.",
                        style: TextStyle(color: AppColors.greyText),
                      ),
                      SizedBox(
                        height: 20.h,
