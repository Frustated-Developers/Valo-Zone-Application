...
class FrenzyDialog extends StatelessWidget {
  const FrenzyDialog({super.key});
          ...
          child: Column(
              ...
              children: [
                ClipRRect(
                    ...
                    child: Image.asset(AssetPath.frenzy_gun)),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "The Frenzy is a rapid-fire pistol. Great for fast-paced close encounters.",
                        style: TextStyle(color: AppColors.greyText),
                      ),
                      SizedBox(
                        height: 20.h,
