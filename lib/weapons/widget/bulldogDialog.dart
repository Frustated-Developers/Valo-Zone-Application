...
class BulldogDialog extends StatelessWidget {
  const BulldogDialog({super.key});
          ...
          child: Column(
              ...
              children: [
                ClipRRect(
                    ...
                    child: Image.asset(AssetPath.bulldog_gun)),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "The Bulldog is a budget-friendly rifle. Burst mode increases its precision.",
                        style: TextStyle(color: AppColors.greyText),
                      ),
                      SizedBox(
                        height: 20.h,
