...
class KayoWallpaper extends StatefulWidget {
  const KayoWallpaper({super.key});

  @override
  State<KayoWallpaper> createState() => _KayoWallpaperState();
}

class _KayoWallpaperState extends State<KayoWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('kayo').get();
