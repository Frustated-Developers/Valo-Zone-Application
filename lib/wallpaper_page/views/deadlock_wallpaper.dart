...
class DeadlockWallpaper extends StatefulWidget {
  const DeadlockWallpaper({super.key});

  @override
  State<DeadlockWallpaper> createState() => _DeadlockWallpaperState();
}

class _DeadlockWallpaperState extends State<DeadlockWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('deadlock').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.deadlock_wallpaper),
                        fit: BoxFit.cover,
                      ),
