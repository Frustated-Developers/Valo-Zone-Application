...
class VyseWallpaper extends StatefulWidget {
  const VyseWallpaper({super.key});

  @override
  State<VyseWallpaper> createState() => _VyseWallpaperState();
}

class _VyseWallpaperState extends State<VyseWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('vyse').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.vyse_wallpaper),
                        fit: BoxFit.cover,
                      ),
