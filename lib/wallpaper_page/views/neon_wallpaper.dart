...
class NeonWallpaper extends StatefulWidget {
  const NeonWallpaper({super.key});

  @override
  State<NeonWallpaper> createState() => _NeonWallpaperState();
}

class _NeonWallpaperState extends State<NeonWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('neon').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.neon_wallpaper),
                        fit: BoxFit.cover,
                      ),
