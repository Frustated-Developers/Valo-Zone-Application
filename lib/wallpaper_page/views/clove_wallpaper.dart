...
class CloveWallpaper extends StatefulWidget {
  const CloveWallpaper({super.key});

  @override
  State<CloveWallpaper> createState() => _CloveWallpaperState();
}

class _CloveWallpaperState extends State<CloveWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('clove').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.clove_wallpaper),
                        fit: BoxFit.cover,
                      ),
