...
class SageWallpaper extends StatefulWidget {
  const SageWallpaper({super.key});

  @override
  State<SageWallpaper> createState() => _SageWallpaperState();
}

class _SageWallpaperState extends State<SageWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('sage').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.sage_wallpaper),
                        fit: BoxFit.cover,
                      ),
