...
class SovaWallpaper extends StatefulWidget {
  const SovaWallpaper({super.key});

  @override
  State<SovaWallpaper> createState() => _SovaWallpaperState();
}

class _SovaWallpaperState extends State<SovaWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('sova').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.sova_wallpaper),
                        fit: BoxFit.cover,
                      ),
