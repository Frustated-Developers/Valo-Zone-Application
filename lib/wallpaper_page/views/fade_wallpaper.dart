...
class FadeWallpaper extends StatefulWidget {
  const FadeWallpaper({super.key});

  @override
  State<FadeWallpaper> createState() => _FadeWallpaperState();
}

class _FadeWallpaperState extends State<FadeWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('fade').get();
