...
class JettWallpaper extends StatefulWidget {
  const JettWallpaper({super.key});

  @override
  State<JettWallpaper> createState() => _JettWallpaperState();
}

class _JettWallpaperState extends State<JettWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('jett').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.jett_wallpaper),
                        fit: BoxFit.cover,
                      ),
