...
class RajaWallpaper extends StatefulWidget {
  const RajaWallpaper({super.key});

  @override
  State<RajaWallpaper> createState() => _RajaWallpaperState();
}

class _RajaWallpaperState extends State<RajaWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('raja').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.raja_wallpaper),
                        fit: BoxFit.cover,
                      ),
