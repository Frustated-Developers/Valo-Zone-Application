...
class ReynaWallpaper extends StatefulWidget {
  const ReynaWallpaper({super.key});

  @override
  State<ReynaWallpaper> createState() => _ReynaWallpaperState();
}

class _ReynaWallpaperState extends State<ReynaWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('reyna').get();
