...
class BrimstoneWallpaper extends StatefulWidget {
  const BrimstoneWallpaper({super.key});

  @override
  State<BrimstoneWallpaper> createState() => _BrimstoneWallpaperState();
}

class _BrimstoneWallpaperState extends State<BrimstoneWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('brimstone').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.brimstone_wallpaper),
                        fit: BoxFit.cover,
                      ),
