...
class PhoenixWallpaper extends StatefulWidget {
  const PhoenixWallpaper({super.key});

  @override
  State<PhoenixWallpaper> createState() => _PhoenixWallpaperState();
}

class _PhoenixWallpaperState extends State<PhoenixWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('pheonix').get();
