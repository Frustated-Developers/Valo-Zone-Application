...
class AstraWallpaper extends StatefulWidget {
  const AstraWallpaper({super.key});

  @override
  State<AstraWallpaper> createState() => _AstraWallpaperState();
}

class _AstraWallpaperState extends State<AstraWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('astra').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.astra_wallpaper),
                        fit: BoxFit.cover,
                      ),
