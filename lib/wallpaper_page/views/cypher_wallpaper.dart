...
class CypherWallpaper extends StatefulWidget {
  const CypherWallpaper({super.key});

  @override
  State<CypherWallpaper> createState() => _CypherWallpaperState();
}

class _CypherWallpaperState extends State<CypherWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('cypher').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.cypher_wallpaper),
                        fit: BoxFit.cover,
                      ),
