...
class OmenWallpaper extends StatefulWidget {
  const OmenWallpaper({super.key});

  @override
  State<OmenWallpaper> createState() => _OmenWallpaperState();
}

class _OmenWallpaperState extends State<OmenWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('omen').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.omen_wallpaper),
                        fit: BoxFit.cover,
                      ),
