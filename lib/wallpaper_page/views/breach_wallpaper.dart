...
class BreachWallpaper extends StatefulWidget {
  const BreachWallpaper({super.key});

  @override
  State<BreachWallpaper> createState() => _BreachWallpaperState();
}

class _BreachWallpaperState extends State<BreachWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('breach').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.breach_wallpaper),
                        fit: BoxFit.cover,
                      ),
