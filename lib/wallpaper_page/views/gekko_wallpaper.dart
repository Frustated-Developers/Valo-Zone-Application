...
class GekkoWallpaper extends StatefulWidget {
  const GekkoWallpaper({super.key});

  @override
  State<GekkoWallpaper> createState() => _GekkoWallpaperState();
}

class _GekkoWallpaperState extends State<GekkoWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('gekko').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.gekko_wallpaper),
                        fit: BoxFit.cover,
                      ),
