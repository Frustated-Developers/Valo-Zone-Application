...
class ChamberWallpaper extends StatefulWidget {
  const ChamberWallpaper({super.key});

  @override
  State<ChamberWallpaper> createState() => _ChamberWallpaperState();
}

class _ChamberWallpaperState extends State<ChamberWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('chamber').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.chamber_wallpaper),
                        fit: BoxFit.cover,
                      ),
