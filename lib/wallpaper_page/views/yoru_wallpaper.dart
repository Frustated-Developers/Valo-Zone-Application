...
class YoruWallpaper extends StatefulWidget {
  const YoruWallpaper({super.key});

  @override
  State<YoruWallpaper> createState() => _YoruWallpaperState();
}

class _YoruWallpaperState extends State<YoruWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('yoru').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.yoru_wallpaper),
                        fit: BoxFit.cover,
                      ),
