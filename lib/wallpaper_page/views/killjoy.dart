...
class KilljoyWallpaper extends StatefulWidget {
  const KilljoyWallpaper({super.key});

  @override
  State<KilljoyWallpaper> createState() => _KilljoyWallpaperState();
}

class _KilljoyWallpaperState extends State<KilljoyWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('killjoy').get();
