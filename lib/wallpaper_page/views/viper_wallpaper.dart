...
class ViperWallpaper extends StatefulWidget {
  const ViperWallpaper({super.key});

  @override
  State<ViperWallpaper> createState() => _ViperWallpaperState();
}

class _ViperWallpaperState extends State<ViperWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('viper').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.viper_wallpaper),
                        fit: BoxFit.cover,
                      ),
