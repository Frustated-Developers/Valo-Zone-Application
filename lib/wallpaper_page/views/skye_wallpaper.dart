...
class SkyeWallpaper extends StatefulWidget {
  const SkyeWallpaper({super.key});

  @override
  State<SkyeWallpaper> createState() => _SkyeWallpaperState();
}

class _SkyeWallpaperState extends State<SkyeWallpaper> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot =
        await FirebaseFirestore.instance.collection('skye').get();
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(AssetPath.skye_wallpaper),
                        fit: BoxFit.cover,
                      ),
